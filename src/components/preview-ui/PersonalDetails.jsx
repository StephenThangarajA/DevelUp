...
import { FaEnvelope, FaGithub, FaLaptop, FaLinkedin, FaPhone } from 'react-icons/fa6'
	...
	return (
		<>
			<div className='text-center'>
				<h1 className='text-3xl uppercase tracking-normal font-medium'>{name}</h1>
			...
			<div className='flex flex-wrap justify-center items-center gap-2 text-sm'>
				...
				{linkedin && (
					<div className='flex items-center gap-1'>
						<FaLinkedin size={12} />
						<a href={linkedin} className='underline'>Linkedin</a>
					</div>
				)}
				{github && (
					<div className='flex items-center gap-1'>
